...
const PendetaDashboard = () => {
  ...
  const title = tenantProfile?.nama_jemaat_lokal
    ? `Pendeta ${tenantProfile.nama_jemaat_lokal}`
    : 'Dashboard Pendeta';
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 12 }}>
              ...
              <tfoot>
                <tr style={{ background: '#1B4332', color: 'white', fontWeight: 700 }}>
                  <td colSpan={3} style={{ ...tdStyle, fontWeight: 700 }}>Total Keseluruhan</td>
...
export default PendetaDashboard;
